        ...
        <div className="col-12">
          <div className="rounded bg-white shadow my-3">
            <div className="d-flex align-items-center justify-content-start mx-3">
              <h5 className="price-text mt-4">
                My Orders <RiShoppingBag3Fill />
              </h5>
            </div>
            <hr />
            {/* Shopping cart table */}
                        ...
                        orderDataList?.map((ite) => {
                          return (
                            <tr key={ite?.id}>
                              ...
                              <td className="border-0 text-muted align-middle">
                                {handleBadge(ite?.status)}
                              </td>
                              <td className="border-0 text-muted align-middle">
                                Rs {parseFloat(ite?.total_amount).toFixed(0)}
                              </td>
                              <td className="border-0 align-middle">
                                <NavLink
                                  to={`/productSuccess/${ite.id}`}
